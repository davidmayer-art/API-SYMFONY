 ...
 */
class getTrotinetteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TrotinetteRepository' shared autowired service.
     *
     * @return \App\Repository\TrotinetteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TrotinetteRepository.php';

        return $container->privates['App\\Repository\\TrotinetteRepository'] = new \App\Repository\TrotinetteRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
